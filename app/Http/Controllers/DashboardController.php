...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        return view('dashboard', compact('humidity','temperature','fire','energy_today','energy_month','energy_cost','energy_cost_delay','energy_current','energy_cost_pokok','energy_submonth','energies','energy','energy2','energy_outlet','energy_outlet_master','energy_panel','controls','dimmer',
