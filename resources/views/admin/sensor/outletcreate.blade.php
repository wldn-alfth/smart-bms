...
<div class="page-content">
    ...
    <div class="bg-dash-dark-1 py-4">
      <div class="container-fluid">
        <h2 class="h5 mb-0">Tambah Outlet</h2>
      </div>
    </div>
  <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body pt-0">
                        <form class="form-horizontal" id="formNewUser" name="formNewUser" method="POST" action="{{ route('storeOutletList') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <select id="status" name="status" class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" form="formNewUser">
