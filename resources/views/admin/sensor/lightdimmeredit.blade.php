...
<div class="page-content">
    ...
    <div class="bg-dash-dark-1 py-4">
      <div class="container-fluid">
        <h2 class="h5 mb-0">Edit Lampu Dimmer</h2>
      </div>
    </div>
  <div class="container-fluid">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body pt-0">
                            ...
                            <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST" action="{{ route('updateLightDimmerList') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$editlightdimmers->id}}">
                                <div class="form-group mb-3">
                                    <label for="name-edit" class="col-dm-6 control-label">Nama</label>
                                    <div class="col-center">
                                        <input type="text" id="nama-edit" name="nama-edit"  value="{{$editlightdimmers->nama}}" class="form-control">
                                    </div>
                                </div>
