                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row d-flex justify-content-center pt-0">
                                            <div class="col-lg-12">
                                                <p class="text-xl fw-light mb-0 text-center text-info">.../api/ApiLight/{{$lightshows->id}}</p><span>
                                                ...
                                                <p class="text text-start fw-light mb-0 text-primary">http://www.domainsaya.com/<a class="text text-start fw-light mb-0 text-show">api/ApiLight/{{$lightshows->id}}</p><span>
                                                </a>
