...
<div class="page-content">
    ...
    <div class="bg-dash-dark-1 py-4">
      <div class="container-fluid">
        <h2 class="h5 mb-0">Tambah Camera</h2>
      </div>
    </div>
  <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body pt-0">
                        <form class="form-horizontal" id="formNewUser" name="formNewUser" method="POST" action="{{ route('storeCameraList') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group mb-3">
                                <label for="name" class="col-dm-6 control-label">IP/Link</label>
                                <div class="col-center">
