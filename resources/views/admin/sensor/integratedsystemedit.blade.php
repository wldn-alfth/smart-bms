...
<div class="page-content">
    ...
    <div class="bg-dash-dark-1 py-4">
      <div class="container-fluid">
        <h2 class="h5 mb-0">Edit Sistem</h2>
      </div>
    </div>
  <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body pt-0">
                            ...
                            @foreach($editcamera as $editcameras)
                            <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST" action="{{ route('updateintegratedsystemList') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$editcameras->id}}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-center">
                                        <input type="text" id="deskripsi-edit" name="deskripsi-edit"  value="{{$editcameras->deskripsi}}" class="form-control">
                                    </div>
                                </div>
