                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body pt-0">
                            ...
                            <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST" action="{{ route('updatePanelList') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$editpanels->id}}">
                                <div class="form-group mb-3">
                                    <label for="name-edit" class="col-dm-6 control-label">Nama</label>
                                    <div class="col-center">
                                        <input type="text" id="nama-edit" name="nama-edit"  value="{{$editpanels->nama}}" class="form-control">
                                    </div>
                                </div>
